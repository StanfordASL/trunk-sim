...
control_scale = 0.01  # before was 0.002 Scale for control inputs
...
folder_path = os.path.abspath(os.path.join(current_dir, '..', 'trajectories_b_test', 'data_with_lambda_controlled_less_movement'))
...
for traj_idx in range(num_trajectories):
    ...
    amplitudes_circle = amplitude_scaling_factor * control_scale * np.ones(num_controls)
    ...
    step_moment = 1  # timepoint at which we are doing the step
    ...
    with mujoco.Renderer(model) as renderer:
        ...
        while data.time < duration:
            ...
            current_real_control, current_desired_control = compute_u_circle(time, amplitudes_circle, frequency, lambda_matrix, num_controls, last_time, last_real_control, step_moment)
    ...
    if create_video:
        ...
        video_folder = os.path.abspath(os.path.join(current_dir, '..', 'trajectories_b_test', 'videos_with_lambda_controlled_less_movement'))
